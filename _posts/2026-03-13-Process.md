...
**Process**란 실행 중인 프로그램(**Program in Execution**)을 의미.
...
프로세스에 할당되는 Memory 공간은 다음 **4가지 영역**으로 구성.
...
각 Process는 이러한 Memory 공간을 **독립적으로 할당받는 구조**.
